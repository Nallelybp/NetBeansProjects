...
Models_lme4gs <- function(yy=y, datos, gen=gen, Markers=NULL, Pedigree=NULL, RandomBox="false", FixedBox="false"){
  ...
  names(yy)=gen
  out<-lmer_uvcov_beta(yy,fixed=1,random=random)
  summary(out)
...
CV_Predict<- function(yy, nfolds=10, typeCV="Folds", datos, gen=gen, Markers=NULL, Pedigree=NULL, RandomBox="false", FixedBox="false") {
